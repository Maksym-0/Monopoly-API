namespace Monopoly.Core
{
    public static class Constants
    {
        ...
        public static readonly List<string> CellsMonopolyTypes = new List<string>
        {
            "Супермаркети", "Банки", "Фастфуд", "Одяг", "Процесори", "Ігрові консолі", "Мобільні оператори", "IT-продукти", "Напої"
        };
        ...
        public static readonly List<int> CellUpgradAndSellCost = new List<int>
        {
        ...
        public static readonly int LeavePrisonCost = 200;
        public static readonly int BonusForLap = 100;
    }
}
